...
<html lang="">
	<head>
		...
		<script src="http://localhost/myphpmvc/public/js/examplejs/example.js" type="text/javascript"></script>
		<script src="http://localhost/myphpmvc/public/js/examplejs/example_evt.js"  type="text/javascript"></script>
